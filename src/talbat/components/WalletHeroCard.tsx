  ...
  return (
    <div className="relative w-full">
      ...
      {/* Main Luxury Wallet Card */}
          ...
          <div className="relative z-10 pt-2 mt-4 border-t border-on-ink/10 flex flex-col divide-y divide-on-ink/10 sm:grid sm:grid-cols-3 sm:gap-2 sm:divide-y-0 sm:pt-3">
            {/* Deposits */}
            <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 py-2 sm:block sm:px-2 sm:py-1">
              <div className="flex min-w-0 items-center gap-1 text-[11px] font-medium text-ink-muted sm:mb-0.5 sm:text-xs">
                <span className="w-1.5 h-1.5 shrink-0 rounded-full bg-done" />
                <span className="truncate">عربون محصّل</span>
              </div>
              <div className="shrink-0 text-sm font-bold font-cairo text-done">
            ...
            <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 py-2 sm:block sm:px-2 sm:py-1">
              <div className="flex min-w-0 items-center gap-1 text-[11px] font-medium text-ink-muted sm:mb-0.5 sm:text-xs">
                <span className="w-1.5 h-1.5 shrink-0 rounded-full bg-brass-light" />
                <span className="truncate">متبقي عند الاستلام</span>
              </div>
              <div className="shrink-0 text-sm font-bold font-cairo text-brass-light">
            ...
            <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-2 py-2 sm:block sm:px-2 sm:py-1">
              <div className="flex min-w-0 items-center gap-1 text-[11px] font-medium text-ink-muted sm:mb-0.5 sm:text-xs">
                <span className="w-1.5 h-1.5 shrink-0 rounded-full bg-late" />
                <span className="truncate">مرتجع معلق</span>
              </div>
              <div className="shrink-0 text-sm font-bold font-cairo text-late">
