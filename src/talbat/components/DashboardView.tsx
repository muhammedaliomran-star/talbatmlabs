    ...
    <div className="grain-overlay relative bg-paper text-charcoal">
      ...
      <div data-reveal className="reveal-section mb-8">
        <div className="inline-flex items-center gap-2 rounded-full bg-ink-deep px-3.5 py-1.5 ring-1 ring-white/10">
          ...
          <span className="text-[11px] font-semibold tracking-[0.14em] text-on-ink">Atelier Dashboard — Live Ledger</span>
        </div>
      ...
      <div className="relative grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-5 mb-8">
        ...
        <div data-reveal className="reveal-section lg:col-span-8 lg:rotate-[-0.6deg] lg:hover:rotate-[0deg] transition-transform duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] will-change-transform" style={{ transitionDelay: '80ms' }}>
      ...
      <div data-reveal className="reveal-section lg:rotate-[-0.2deg] hover:rotate-[0deg] transition-transform duration-700 ease-[cubic-bezier(0.32,0.72,0,1)] will-change-transform" style={{ transitionDelay: '260ms' }}>
