    ...
    <div className="space-y-8">
      ...
      <div data-reveal className="reveal-section">
        ...
        <div className="mt-4 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
          <div>
            <h1 className="font-[Fraunces] text-[32px] sm:text-[40px] lg:text-[48px] font-[800] leading-[0.9] tracking-[-0.03em] text-charcoal">
              سجل <span className="italic font-[700] text-late">المرتجعات</span> وحسابات الموردين <span className="text-lg align-middle font-cairo font-bold text-copy-muted">({returns.length})</span>
            </h1>
